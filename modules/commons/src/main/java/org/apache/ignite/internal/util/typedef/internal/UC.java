...
import org.apache.ignite.internal.util.IgniteCommonsUtils;

/**
 * Defines internal {@code typedef} for {@link IgniteCommonsUtils}. Since Java doesn't provide type aliases
 ...
 */
public class UC extends IgniteCommonsUtils { /* No-op. */ }
